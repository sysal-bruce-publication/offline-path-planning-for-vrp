...
public:
	...
	/*! @brief		Get randomly generated @c float variable ranging from -3 to 3.
	 *	
	 *  Please note that the function is used to simulate the error due to GPS 
	 *  localization precision. The offset @f[ \pm 3 @f] meters is a reasonable 
	 *  range in real life.
	 *
	 *  @return		Random @c float variable ranging from -3 to 3 [m]
	 */
	 ...
	 *
	 *  Related formula: Energy @f[ E = P * t @f]
	 *  
	 ...
	 *
	 *  Related formula: Time @f[ t = 20 / V_{asc} @f]
	 *
	 *  @param t		Spent time [h].
	 ...
	 *
	 *  Related formula: Time @f[ t = 20 / V_{des} @f]
	 *
	 *  @param t		Spent time [h].
	 *  @param e		Energy variable to be updated.
	 */
	 ...
	 *  
	 *  Related formula: Time @f[ t = (10 - \text{offset}) / V_{UWB} @f]
	 *
	 *  @param rand_offset	Random @c float variable ranging from -3 to 3 [m]
	 *  @param t		Spent time [h].
	 *  @param e		Energy variable to be updated.
	 */
	 ...
	 *
	 *  Related formula: Time @f[ t = (d - (10 - \text{offset})) / V_{GPS} @f]
	 *
	 *  @param rand_offset	Random @c float variable ranging from -3 to 3 [m]
	 ...
	 *
	 *  Related formula: Energy @f[ E = \frac{1}{2 * \eta_{rf2dc} * 3600} * C * (V_{max} - V)^2 @f]
	 *
	 ...
	 */
	float flightSimulation(int cnt, double& charged_e, double& pdv_t, std::vector<SensorNode<T>>& sn_list, std::vector<Point<T>>& path);
